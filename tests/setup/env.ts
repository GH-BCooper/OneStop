...
//
// Two jobs, both about making the suite tell the truth on a developer's machine:
//
...
//   2. Point FFMPEG_PATH/FFPROBE_PATH at a project-local FFmpeg (`node scripts/fetch-ffmpeg.mjs`)
