...
// the real user id.
export const qrTools = defineCategory("qr", { phase: "11", sub: "QR", status: "available" }, [
  ...
  { src: ["10.11"], name: "Dynamic QR Code", in: ["url"], out: ["png", "svg"], net: "required", kw: ["editable", "change destination", "redirect", "qr code"], desc: "Create a QR code whose destination you can change later." },
  { src: ["10.12"], name: "Custom QR Landing Page", in: ["text"], out: ["png", "svg", "url"], net: "required", kw: ["landing page", "hosted page", "qr code"], desc: "Build a OneStop-hosted page for a QR code to open." },
  ...
  { src: ["10.14"], name: "QR Code Analytics", in: [], out: ["json"], net: "required", kw: ["scans", "statistics", "tracking", "qr code"], desc: "See how often your dynamic QR codes are scanned." },
  { src: ["10.15"], name: "QR Code → Content Page", slug: "qr-content-page", in: ["any", "text"], out: ["png", "svg", "url"], net: "required", batch: true, kw: ["hosted content", "files", "share", "qr code"], desc: "Point a QR code at a OneStop page with text, images, audio, links or files." },
]);
