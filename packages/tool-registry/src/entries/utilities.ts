...
export const fileUtilityTools = defineCategory("file-utility", { phase: "12", sub: "File Utilities" }, [
  ...
  { src: ["14.7", "12.21"], name: "File Metadata Viewer", in: ["any"], out: ["json"], batch: true, pop: 30, status: "demo", kw: ["file info", "properties", "size", "mime type"], desc: "See a file's name, size, type and last-modified date." },
