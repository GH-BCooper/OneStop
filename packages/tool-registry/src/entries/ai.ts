...
export const aiTools = defineCategory("ai", { phase: "16", sub: "AI", net: "optional" }, [
  ...
  { src: ["11.14"], name: "AI Image Generator", in: ["text"], out: ["png"], pop: 50, kw: ["generate image", "text to image", "art", "diffusion", "picture"], desc: "Generate an image from a text prompt (needs a capable local model)." },
  { src: ["11.15"], name: "AI Image Editor", in: ["image"], out: ["png"], kw: ["edit image", "inpaint", "photo", "picture"], desc: "Edit an image by describing the change (needs a capable local model)." },
  { src: ["11.16"], name: "AI Background/Object Removal", slug: "ai-background-object-removal", in: ["image"], out: ["png"], kw: ["background", "object", "erase", "cutout", "photo"], desc: "Remove backgrounds or objects using an AI model." },
]);
