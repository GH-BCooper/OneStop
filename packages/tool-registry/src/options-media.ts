...
const sampleRate: SelectOption = {
  ...
  default: "keep",
  choices: [
    choice("keep", "Keep original"),
    choice("48000", "48 kHz"),
    choice("44100", "44.1 kHz"),
    choice("32000", "32 kHz"),
    choice("22050", "22.05 kHz"),
  ],
};
...
const channels: SelectOption = {
  ...
  choices: [
    choice("keep", "Keep original"),
    choice("2", "Stereo"),
    choice("1", "Mono — about half the size"),
  ],
};
...
const trimFields: ToolOption[] = [
  ...
  timeField(
    "end",
    "End at",
    `${TIME_HELP} Leave blank to keep the rest of the file.`,
    "end of file",
  ),
...
export const MEDIA_TOOL_OPTIONS: Record<string, ToolOption[]> = {
  ...
  "audio-compressor": [
    ...
    {
      ...audioBitrate(96, "Used with the Custom setting."),
      showWhen: { option: "level", equals: ["custom"] },
    },
    {
      ...audioFormatSame("Output format"),
      help: "Lossless files (WAV, FLAC) are compressed to MP3.",
    },
    sampleRate,
    channels,
    packaging,
  ...
  "extract-audio": [
    {
      ...
      default: "original",
      choices: [
        choice("original", "Original quality (copy the track, no re-encoding)"),
        ...AUDIO_CHOICES,
      ],
    },
    packaging,
  ...
  "video-to-gif": [
    ...
    { id: "fps", type: "number", label: "Frames per second", default: 10, min: 1, max: 30 },
    {
      ...
      max: 1280,
      unit: "px",
      help: "0 keeps the original width. Height follows automatically.",
    },
  ...
  "video-merger": [
    {
      ...
      default: "same",
      choices: [
        choice("same", "Same as the first clip"),
        ...VIDEO_CHOICES.filter((c) => c.value !== "avi"),
      ],
    },
    {
      id: "size",
      ...
      default: "first",
      choices: [
        choice("first", "Match the first clip"),
        choice("largest", "Match the largest clip"),
      ],
  ...
  "video-resizer": [
    ...
    },
    {
      ...
      default: "black",
      placeholder: "black",
      showWhen: { option: "mode", equals: ["pad"] },
    },
    videoQuality("good"),
    packaging,
  ],
  "rotate-video": [
    {
      ...
      default: "90",
      choices: [
        choice("0", "Don't rotate"),
        choice("90", "90° clockwise"),
        choice("180", "180°"),
        choice("270", "90° anticlockwise"),
      ],
    },
    {
      id: "flip",
      ...
      choices: [
        choice("none", "No flip"),
        choice("horizontal", "Horizontally (mirror)"),
        choice("vertical", "Vertically"),
        choice("both", "Both"),
      ],
    },
    videoQuality("high"),
  ...
  "extract-frames": [
    ...
    },
    {
      ...
      min: 1,
      max: 300,
      showWhen: { option: "mode", equals: ["count"] },
    },
    {
      id: "interval",
      type: "text",
      ...
      default: "1",
      placeholder: "1",
      help: "Seconds between frames, e.g. 0.5 or 5.",
      showWhen: { option: "mode", equals: ["interval"] },
    } as TextOption,
    {
      id: "times",
      type: "text",
      label: "Times",
      default: "",
      placeholder: "0:05, 0:30, 1:10",
      multiline: true,
      help: "Separate times with commas, spaces or new lines.",
      showWhen: { option: "mode", equals: ["times"] },
    },
    {
      id: "time",
      type: "text",
      ...
      placeholder: "0:05",
      help: TIME_HELP,
      showWhen: { option: "mode", equals: ["single"] },
    },
    {
      id: "format",
      type: "select",
      label: "Image format",
      default: "png",
      choices: [choice("png", "PNG — lossless"), choice("jpg", "JPG — smaller")],
    },
    {
      id: "width",
      type: "number",
      ...
      max: 7680,
      unit: "px",
      help: "0 keeps the video's own size.",
    },
    packaging,
  ],
  "subtitle-extraction": [
    {
      ...
      label: "Save as",
      default: "srt",
      choices: [choice("srt", "SRT"), choice("vtt", "WebVTT"), choice("ass", "ASS / SSA")],
    },
    {
      id: "track",
      type: "text",
      ...
      default: "all",
      placeholder: "all",
      help: 'Use "all", or a track number like 1.',
    },
    packaging,
  ],
  "subtitle-conversion": [
  ...
  "change-video-resolution": [
    ...
    },
    {
      ...
      default: false,
      help: "Off: a smaller video is left as it is.",
    } as BooleanOption,
    videoQuality("good"),
    packaging,
  ],
